...
namespace Task05 {
    internal class ComputeMatrixSumVisitor<T>: IMatrixVisitor<T> {
        ...
        public void Visit(SquareMatrix<T> matrix, AbstractMatrix<T> addMatrix) {
            if(matrix == null)
        ...
        public void Visit(SymmetricMatrix<T> matrix, AbstractMatrix<T> addMatrix) {
            if (matrix == null)
                throw new ArgumentNullException(nameof(matrix));
            if (addMatrix == null)
                throw new ArgumentNullException(nameof(addMatrix));
        ...
        public void Visit(DiagonalMatrix<T> matrix, AbstractMatrix<T> addMatrix) {
            if (matrix == null)
                throw new ArgumentNullException(nameof(matrix));
            if (addMatrix == null)
                throw new ArgumentNullException(nameof(addMatrix));
        ...
        private void AddMatrix(AbstractMatrix<T> firstMatrix, AbstractMatrix<T> secondMatrix) {
            try {
